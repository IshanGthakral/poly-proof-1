//import c from "dogs/examples/erc721-transfer/FxERC721RootTunnel.sol"// Import necessary packages and dogs
const { ethers } = require("hardhat");
const { FXRootContractAbi } = require("../artifacts/FXRootContractAbi.js");
const ABI = require("/workspace/Polyproof-mod1/artifacts/contracts/dogs.sol/dogs.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("dogs");
  ...
  // Deposit the nfts to the FXRoot dogs
